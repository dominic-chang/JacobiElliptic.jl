...
function F(φ, m)
    if m > 1.
        ...
        signθ = sign(theta)
        absθ = abs(theta)
        return signθ/m12*_F(absθ, 1.0/m)
        #return NaN
    elseif m < 0.0
...
function _J(n, φ ,m)
    ...
    if φ < φs
        return Js(n, s, m)
    elseif z^2 < ys
        return J(n, m) - Js(n, z, m) - T(ts, h)
    elseif c < w
        return Jc(n, c, m)
    else
        return J(n, m) - Jc(n, w, m) - T(tc, h)
    end
end
        ...
        0.3333333333333333 + y*(
            0.1 + 0.1*m + 0.2*n + y*(
                0.05357142857142857 + n*(0.07142857142857142 + 0.14285714285714285*n) + m*(0.03571428571428571 + 0.05357142857142857*m + 0.07142857142857142*n) + y*(
                    0.034722222222222224 + m*(0.020833333333333332 + m*(0.020833333333333332 + 0.034722222222222224*m + 0.041666666666666664*n) + n*(0.027777777777777776 + 0.05555555555555555*n)) + n*(0.041666666666666664 + n*(0.05555555555555555 + 0.1111111111111111*n)) + y*(
                        0.024857954545454544 + n*(0.028409090909090908 + n*(0.03409090909090909 + n*(0.045454545454545456 + 0.09090909090909091*n))) + m*(0.014204545454545454 + m*(0.01278409090909091 + m*(0.014204545454545454 + 0.024857954545454544*m + 0.028409090909090908*n) + n*(0.017045454545454544 + 0.03409090909090909*n)) + n*(0.017045454545454544 + n*(0.022727272727272728 + 0.045454545454545456*n))) + y*(
                            0.01893028846153846 + m*(0.010516826923076924 + n*(0.01201923076923077 + n*(0.014423076923076924 + n*(0.019230769230769232 + 0.038461538461538464*n))) + m*(0.009014423076923076 + m*(0.009014423076923076 + m*(0.010516826923076924 + 0.01893028846153846*m + 0.021033653846153848*n) + n*(0.01201923076923077 + 0.02403846153846154*n)) + n*(0.010817307692307692 + n*(0.014423076923076924 + 0.028846153846153848*n)))) + n*(0.021033653846153848 + n*(0.02403846153846154 + n*(0.028846153846153848 + n*(0.038461538461538464 + 0.07692307692307693*n)))) + y*(
                                0.0150390625 + m*(0.008203125 + m*(0.0068359375 + m*(0.006510416666666667 + n*(0.0078125 + n*(0.010416666666666666 + 0.020833333333333332*n)) + m*(0.0068359375 + m*(0.008203125 + 0.0150390625*m + 0.01640625*n) + n*(0.009114583333333334 + 0.01818181818181818*n))) + n*(0.0078125 + n*(0.009375 + n*(0.0125 + 0.025*n)))) + n*(0.009114583333333334 + n*(0.010416666666666666 + n*(0.0125 + n*(0.016666666666666666 + 0.03333333333333333*n))))) + n*(0.01640625 + n*(0.018229166666666668 + n*(0.020833333333333332 + n*(0.025 + n*(0.03333333333333333 + 0.06666666666666667*n))))) + y*(
                                    0.012321920955882353 + m*(0.006634880514705882 + m*(0.005428538602941176 + m*(0.0050264246323529415 + n*(0.0057444852941176475 + n*(0.006893382352941176 + n*(0.009191176470588236 + 0.01838235294117647*n))) + m*(0.0050264246323529415 + m*(0.005428538602941176 + m*(0.006634880514705882 + 0.012321920955882353*m + 0.013269761029411764*n) + n*(0.007238051470588236 + 0.014476102941176471*n)) + n*(0.00603170955882353 + n*(0.008042279411764705 + 0.01608455882352941*n)))) + n*(0.00603170955882353 + n*(0.006893382352941176 + n*(0.008272058823529412 + n*(0.011029411764705883 + 0.022058823529411766*n))))) + n*(0.007238051470588236 + n*(0.008042279411764705 + n*(0.009191176470588236 + n*(0.011029411764705883 + n*(0.014705882352941176 + 0.029411764705882353*n)))))) + n*(0.013269761029411764 + n*(0.014476102941176471 + n*(0.01608455882352941 + n*(0.01838235294117647 + n*(0.022058823529411766 + n*(0.029411764705882353 + 0.058823529411764705*n)))))) + y*(
                                        0.01033582185444079 + n*(0.011024876644736841 + n*(0.011872944078947368 + n*(0.012952302631578948 + n*(0.014391447368421052 + n*(0.01644736842105263 + n*(0.019736842105263157 + n*(0.02631578947368421 + 0.05263157894736842*n))))))) + m*(0.005512438322368421 + n*(0.005936472039473684 + n*(0.006476151315789474 + n*(0.007195723684210526 + n*(0.008223684210526315 + n*(0.009868421052631578 + n*(0.013157894736842105 + 0.02631578947368421*n)))))) + m*(0.004452354029605263 + m*(0.004047594572368421 + n*(0.004497327302631579 + n*(0.005139802631578948 + n*(0.006167763157894737 + n*(0.008223684210526315 + 0.01644736842105263*n)))) + m*(0.0039351613898026315 + n*(0.004497327302631579 + n*(0.005396792763157895 + n*(0.007195723684210526 + 0.014391447368421052*n))) + m*(0.004047594572368421 + m*(0.004452354029605263 + n*(0.005936472039473684 + 0.011872944078947368*n) + m*(0.005512438322368421 + 0.01033582185444079*m + 0.011024876644736841*n)) + n*(0.004857113486842105 + n*(0.006476151315789474 + 0.012952302631578948*n))))) + n*(0.004857113486842105 + n*(0.005396792763157895 + n*(0.006167763157894737 + n*(0.007401315789473684 + n*(0.009868421052631578 + 0.019736842105263157*n)))))))
                                    )
                                )
                            )
                        )
...
function el2(x, kc, a, b)
    ...
    while abs(1 - νj/μj) ≥ 1e-6
        ϕj_temp_2 += 2.0^(-j-1)*(1-sign(xj))
    ...
    ϕj_temp_2 += 2.0^(-j-1)*(1-sign(xj))
    ϕj_temp_2 *= 2^j
    ϕj_temp_2 += (1-sign(xj))/2
    ϕj = atan(μj/xj) + π/2*(ϕj_temp_2)
